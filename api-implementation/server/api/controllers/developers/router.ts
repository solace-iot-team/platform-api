...
export default express
  ...
  .get('/:developer/apps/:name/credentials', controller.allAppCredentials)
  .post('/:developer/apps/:name/credentials', controller.createCredentials)
  .patch('/:developer/apps/:app/credentials/:name', controller.updateCredentials)
  .delete('/:developer/apps/:app/credentials/:name', controller.deleteCredentials)
