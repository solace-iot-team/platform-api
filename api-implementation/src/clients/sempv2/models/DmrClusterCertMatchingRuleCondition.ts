...
export type DmrClusterCertMatchingRuleCondition = {
    /**
     ...
     *
     */
    source?: DmrClusterCertMatchingRuleCondition.source;
}

export namespace DmrClusterCertMatchingRuleCondition {

    /**
     * the discriminator for the model if required for more complex api's
     */
    export const discriminator = 'DmrClusterCertMatchingRuleCondition';
